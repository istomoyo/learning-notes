/*
 * @Author: tomoyo
 * @Date: 2026-01-22 15:45:16
 * @Last Modified by: tomoyo
 * @Last Modified time: 2026-01-22 16:12:33
 */
...
// publickey
const run = async function (html) {
  // RSA加密
  const match = html.match(/var\s+publicKey\s*=\s*'([^']+)'/);
  ...
  var rsaAccount = rsaEncrypt("admin");
  var rsaPassword = rsaEncrypt("123456");
  ...
  fetchWithCookie(
    `https://st.bczp.cn/ajax/login/jwlogin.ashx?r=${Math.random()}`,
    {
      headers: {
        accept: "application/json, text/javascript, */*; q=0.01",
        "accept-language": "zh,en;q=0.9,zh-CN;q=0.8",
        "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
        Referer: "https://st.bczp.cn/login/jwlogin.aspx",
        userAgent: userAgent,
      },
      body: params,
      method: "POST",
...
fetchWithCookie("https://st.bczp.cn/login/jwlogin.aspx", {
  headers: {
    userAgent: userAgent,
  },
})
